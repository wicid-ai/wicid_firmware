...
class ButtonActionRouter:
    ...
    def acquire_session(self, session_logger=None):
        """
    ...
    @staticmethod
    def _remove_action_from_queue(action, queue):
...
class _ButtonActionSession:
    ...
    def __init__(self, router, session_logger=None):
        self._router = router
        self._queue = []
